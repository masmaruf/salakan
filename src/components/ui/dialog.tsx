...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg font-bold leading-none text-on-surface tracking-tight",
      className
    )}
    {...props}
  />
